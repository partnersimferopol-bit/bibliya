...
export default function TermsPage() {
  return (
    <LegalDocument
      ...
      intro={`Пожалуйста, прочитайте настоящие Условия перед использованием игры «${LEGAL_SITE_NAME}». Они описывают правила бесплатного доступа, детский режим и порядок добровольных пожертвований.`}
